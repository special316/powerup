    ...
    def handlemessage(self, msg: Any) -> Any:
        ...
        if isinstance(msg, ba.PickedUpMessage):
            ...
            if msg.poweruptype == 'triple_bombs':
                ...
                self._num_times_hit = 0
            elif msg.poweruptype == 'random_bombs':
                powerupl = ['ice_bombs', 'sticky_bombs', 'impact_bombs']
                randomp = r.choice(powerupl)
                self.node.handlemessage(ba.PowerupMessage(randomp))
                ba.emitfx(
                    velocity=1.5
                )
